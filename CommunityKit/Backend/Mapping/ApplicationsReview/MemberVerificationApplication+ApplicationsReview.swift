//
//  MemberVerificationApplication+ApplicationsReview.swift
//  CommunitySDK
//
...
extension MemberVerificationApplication {
    ...
    init(output: ApplicationsQuery.Data.Application.Application) throws {
    ...
    init(output: ApproveApplicationMutation.Data.ApproveApplication.Application) throws {
        var state: MemberVerificationApplication.State
        switch output.state {
        case .__unknown(_):
            throw ResponseError.unknownMembershipApplicationState
    ...
    init(output: RejectApplicationMutation.Data.RejectApplication.Application) throws {
        var state: MemberVerificationApplication.State
        switch output.state {
        case .__unknown(_):
            throw ResponseError.unknownMembershipApplicationState
